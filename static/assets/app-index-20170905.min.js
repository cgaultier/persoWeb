if (function(t, e) {
    ...
    function h(t, e, n, i, o) {
        for (var r, a, s, l, u, h, f = e.createDocumentFragment(), p = [], g = 0, m = t.length; g < m; g++)
            if (r = t[g], r || 0 === r)
                if ("object" === rt.type(r))
                    rt.merge(p, r.nodeType ? [r] : r);
                else if (_t.test(r)) {
                    for (a = a || f.appendChild(e.createElement("div")), s = (Ot.exec(r) || ["", ""])[1].toLowerCase(), l = Lt[s] || Lt._default, a.innerHTML = l[1] + rt.htmlPrefilter(r) + l[2], h = l[0]; h--;)
                        a = a.lastChild;
                    rt.merge(p, a.childNodes), a = f.firstChild, a.textContent = ""
                } else
                    p.push(e.createTextNode(r));
        for (f.textContent = "", g = 0; r = p[g++];)
            if (i && rt.inArray(r, i) > -1)
                o && o.push(r);
            else if (u = rt.contains(r.ownerDocument, r), a = c(f.appendChild(r), "script"), u && d(a), n)
                for (h = 0; r = a[h++];)
                    Rt.test(r.type || "") && n.push(r);
        return f
    }
    function f() {
        return !0
    ...
    function k(t, e, n, i) {
        ...
        var o,
            ...
            g = e[0],
            m = rt.isFunction(g);
        if (m || f > 1 && "string" == typeof g && !it.checkClone && jt.test(g))
            return t.each(function(o) {
                var r = t.eq(o);
                m && (e[0] = g.call(this, o, r.html())), k(r, e, n, i)
            });
        if (f && (o = h(e, t[0].ownerDocument, !1, t, i), r = o.firstChild, 1 === o.childNodes.length && (o = r), r || i)) {
            for (a = rt.map(c(o, "script"), y), s = a.length; d < f; d++)
                l = o, d !== p && (l = rt.clone(l, !0, !0), s && rt.merge(a, c(l, "script"))), n.call(t[d], l, d);
            if (s)
                for (u = a[a.length - 1].ownerDocument, rt.map(a, b), d = 0; d < s; d++)
                    l = a[d], Rt.test(l.type || "") && !Tt.access(l, "globalEval") && rt.contains(u, l) && (l.src ? rt._evalUrl && rt._evalUrl(l.src) : rt.globalEval(l.textContent.replace(qt, "")))
        }
        return t
    }
    function C(t, e, n) {
        for (var i, o = e ? rt.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
            n || 1 !== i.nodeType || rt.cleanData(c(i)), i.parentNode && (n && rt.contains(i.ownerDocument, i) && d(c(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    function S(t, e) {
    ...
    function D(t, e, n) {
        var i,
            ...
            a,
            s = t.style;
        return n = n || Kt(t), a = n ? n.getPropertyValue(e) || n[e] : void 0, "" !== a && void 0 !== a || rt.contains(t.ownerDocument, t) || (a = rt.style(t, e)), n && !it.pixelMarginRight() && Qt.test(a) && Xt.test(e) && (i = s.width, o = s.minWidth, r = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = i, s.minWidth = o, s.maxWidth = r), void 0 !== a ? a + "" : a
    }
    function A(t, e) {
        return {
            get: function() {
    ...
    function P(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; r < 4; r += 2)
            "margin" === n && (a += rt.css(t, n + Et[r], !0, o)), i ? ("content" === n && (a -= rt.css(t, "padding" + Et[r], !0, o)), "margin" !== n && (a -= rt.css(t, "border" + Et[r] + "Width", !0, o))) : (a += rt.css(t, "padding" + Et[r], !0, o), "padding" !== n && (a += rt.css(t, "border" + Et[r] + "Width", !0, o)));
        return a
    }
    function E(t, e, n) {
        var i = !0,
        ...
        if (o <= 0 || null == o) {
            if (o = D(t, e, r), (o < 0 || null == o) && (o = t.style[e]), Qt.test(o))
                return o;
    ...
    function F(t, e) {
        for (var n, i, o, r = [], a = 0, s = t.length; a < s; a++)
            i = t[a], i.style && (r[a] = Tt.get(i, "olddisplay"), n = i.style.display, e ? (r[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ft(i) && (r[a] = Tt.access(i, "olddisplay", T(i.nodeName)))) : (o = Ft(i), "none" === n && o || Tt.set(i, "olddisplay", o ? n : rt.css(i, "display"))));
        for (a = 0; a < s; a++)
    ...
    function _(t, e, n) {
        ...
        if (rt.isEmptyObject(h))
            ...
            for (i in h)
                a = L(p ? g[i] : 0, i, d), i in g || (g[i] = a.start, p && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    function B(t, e) {
        var n,
    ...
    function W(t, e, n) {
        var i,
            ...
            l = function() {
                if (o)
                    return !1;
                for (var e = oe || O(), n = Math.max(0, u.startTime + u.duration - e), i = n / u.duration || 0, r = 1 - i, a = 0, l = u.tweens.length; a < l; a++)
                    u.tweens[a].run(r);
        ...
        for (B(c, u.opts.specialEasing); r < a; r++)
            if (i = W.prefilters[r].call(u, t, c, u.opts))
                return rt.isFunction(i.stop) && (rt._queueHooks(u.elem, u.opts.queue).stop = rt.proxy(i.stop, i)), i;
    ...
    rt.fn = rt.prototype = {
        ...
        var t,
            ...
            l = arguments.length,
            u = !1;
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || rt.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
            if (null != (t = arguments[s]))
                for (e in t)
                    n = a[e], i = t[e], a !== i && (u && i && (rt.isPlainObject(i) || (o = rt.isArray(i))) ? (o ? (o = !1, r = n && rt.isArray(n) ? n : []) : r = n && rt.isPlainObject(n) ? n : {}, a[e] = rt.extend(u, r, i)) : void 0 !== i && (a[e] = i));
        return a
    }, rt.extend({
        ...
        proxy: function(t, e) {
            var n,
                i,
                o;
            if ("string" == typeof e && (n = t[e], e = t, t = n), rt.isFunction(t))
                return i = K.call(arguments, 2), o = function() {
    ...
    var ct = function(t) {
        function e(t, e, n, i) {
            ...
            if (n = n || [], "string" != typeof t || !t || 1 !== g && 9 !== g && 11 !== g)
                return n;
            if (!i && ((e ? e.ownerDocument || e : V) !== F && E(e), e = e || F, O)) {
                if (11 !== g && (u = vt.exec(t)))
                    if (o = u[1]) {
                        if (9 === g) {
                            ...
                            if (a.id === o)
                                return n.push(a), n
                        } else if (p && (a = p.getElementById(o)) && B(e, a) && a.id === o)
                            return n.push(a), n
                    } else {
                        if (u[2])
                ...
                if (w.qsa && !q[t + " "] && (!R || !R.test(t))) {
                    if (1 !== g)
                        ...
                        for ((s = e.getAttribute("id")) ? s = s.replace(bt, "\\$&") : e.setAttribute("id", s = W), d = T(t), r = d.length, l = ht.test(s) ? "#" + s : "[id='" + s + "']"; r--;)
                            d[r] = l + " " + h(d[r]);
        ...
        function f(t, e, n) {
            ...
            return e.first ? function(e, n, r) {
                ...
                if (a) {
                    ...
                    for (; e = e[i];)
                        if (1 === e.nodeType || o) {
                            if (u = e[W] || (e[W] = {}), l = u[e.uniqueID] || (u[e.uniqueID] = {}), (s = l[i]) && s[0] === H && s[1] === r)
                                return c[2] = s[2];
                            if (l[i] = c, c[2] = t(e, n, a))
                                return !0
                        }
            }
        }
        ...
        function v(t, e, n, o, r, a) {
            return o && !o[W] && (o = v(o)), r && !r[W] && (r = v(r, a)), i(function(i, a, s, l) {
                var u,
                    ...
                    b = n ? r || (i ? t : p || o) ? [] : a : y;
                if (n && n(y, b, s, l), o)
                    for (u = m(b, f), o(u, [], s, l), c = u.length; c--;)
                        (d = u[c]) && (b[f[c]] = !(y[f[c]] = d));
                if (i) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (c = b.length; c--;)
                            (d = b[c]) && (u = r ? tt(i, d) : h[c]) > -1 && (i[u] = !(a[u] = d))
                    }
                } else
                    b = m(b === a ? b.splice(p, b.length) : b), r ? r(null, a, b, l) : J.apply(a, b)
            })
        }
        function y(t) {
            for (var e, n, i, o = t.length, r = k.relative[t[0].type], a = r || k.relative[" "], s = r ? 1 : 0, l = f(function(t) {
                    ...
                    var o = !r && (i || n !== M) || ((e = n).nodeType ? l(t, n, i) : u(t, n, i));
                    return e = null, o
                }]; s < o; s++)
                if (n = k.relative[t[s].type])
                    ...
                    if (n = k.filter[t[s].type].apply(null, t[s].matches), n[W]) {
                        ...
                        return v(s > 1 && p(c), s > 1 && h(t.slice(0, s - 1).concat({
                            value: " " === t[s - 2].type ? "*" : ""
                        })).replace(st, "$1"), n, s < i && y(t.slice(s, i)), i < o && y(t = t.slice(i)), i < o && h(t))
                    }
                    c.push(n)
                }
            return p(c)
            ...
            var o = n.length > 0,
                ...
                a = function(i, a, s, l, u) {
                    var c,
                        ...
                        w = b.length;
                    for (u && (M = a === F || a || u); p !== w && null != (c = b[p]); p++) {
                        if (r && c) {
                            for (d = 0, a || c.ownerDocument === F || (E(c), s = !O); h = t[d++];)
                                if (h(c, a || F, s)) {
                                    l.push(c);
                                    break
                                }
        ...
        w = e.support = {}, S = e.isXML = function(t) {
            ...
            var e,
                n,
                i = t ? t.ownerDocument || t : V;
            return i !== F && 9 === i.nodeType && i.documentElement ? (F = i, N = F.documentElement, O = !S(F), (n = F.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", kt, !1) : n.attachEvent && n.attachEvent("onunload", kt)), w.attributes = o(function(t) {
                return t.className = "i", !t.getAttribute("className")
            }), w.getElementsByTagName = o(function(t) {
                return t.appendChild(F.createComment("")), !t.getElementsByTagName("*").length
            }), w.getElementsByClassName = mt.test(F.getElementsByClassName), w.getById = o(function(t) {
                return N.appendChild(t).id = W, !F.getElementsByName || !F.getElementsByName(W).length
            ...
            }, L = [], R = [], (w.qsa = mt.test(F.querySelectorAll)) && (o(function(t) {
            ...
            })), (w.matchesSelector = mt.test(_ = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector)) && o(function(t) {
                w.disconnectedMatch = _.call(t, "div"), _.call(t, "[s!='']:x"), L.push("!=", rt)
            }), R = R.length && new RegExp(R.join("|")), L = L.length && new RegExp(L.join("|")), e = mt.test(N.compareDocumentPosition), B = e || mt.test(N.contains) ? function(t, e) {
                ...
                return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === F || t.ownerDocument === V && B(V, t) ? -1 : e === F || e.ownerDocument === V && B(V, e) ? 1 : I ? tt(I, t) - tt(I, e) : 0 : 4 & n ? -1 : 1)
            } : function(t, e) {
                if (t === e)
                    return P = !0, 0;
                var n,
                    ...
                    l = [e];
                if (!o || !r)
                    return t === F ? -1 : e === F ? 1 : o ? -1 : r ? 1 : I ? tt(I, t) - tt(I, e) : 0;
                if (o === r)
                    return a(t, e);
            ...
            if ((t.ownerDocument || t) !== F && E(t), n = n.replace(ct, "='$1']"), w.matchesSelector && O && !q[n + " "] && (!L || !L.test(n)) && (!R || !R.test(n)))
                try {
                    var i = _.call(t, n);
            ...
            return (t.ownerDocument || t) !== F && E(t), B(t, e)
        }, e.attr = function(t, e) {
            (t.ownerDocument || t) !== F && E(t);
                    ...
                    return 1 === i && 0 === o ? function(t) {
                        ...
                        if (m) {
                            ...
                            if (p = [a ? m.firstChild : m.lastChild], a && y) {
                                for (h = m, d = h[W] || (h[W] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[t] || [], f = u[0] === H && u[1], b = f && u[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (b = f = 0) || p.pop();)
                                    if (1 === h.nodeType && ++b && h === e) {
                                        c[t] = [H, f, b];
                                        break
                                    }
                            } else if (y && (h = e, d = h[W] || (h[W] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[t] || [], f = u[0] === H && u[1], b = f), b === !1)
                                for (; (h = ++f && h && h[g] || (b = f = 0) || p.pop()) && ((s ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && (d = h[W] || (h[W] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), c[t] = [H, b]), h !== e));)
                                    ;
        ...
        return d.prototype = k.filters = k.pseudos, k.setFilters = new d, T = e.tokenize = function(t, n) {
            ...
            for (s = t, l = [], u = k.preFilter; s;) {
                ...
                for (a in k.filter)
                    !(o = ft[a].exec(s)) || u[a] && !(o = u[a](o)) || (i = o.shift(), r.push({
                        value: i,
                        type: a,
                        matches: o
                    }), s = s.slice(i.length));
            ...
            if (n = n || [], 1 === d.length) {
                if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (a = r[0]).type && w.getById && 9 === e.nodeType && O && k.relative[r[1].type]) {
                    if (e = (k.find.ID(a.matches[0].replace(xt, wt), e) || [])[0], !e)
                        return n;
                    u && (e = e.parentNode), t = t.slice(r.shift().value.length)
                }
                for (o = ft.needsContext.test(t) ? 0 : r.length; o-- && (a = r[o], !k.relative[s = a.type]);)
                    if ((l = k.find[s]) && (i = l(a.matches[0].replace(xt, wt), yt.test(r[0].type) && c(e.parentNode) || e))) {
    ...
    var mt,
        ...
        yt = rt.fn.init = function(t, e, n) {
            ...
            if (n = n || mt, "string" == typeof t) {
                if (i = "<" === t[0] && ">" === t[t.length - 1] && t.length >= 3 ? [null, t, null] : vt.exec(t), !i || !i[1] && e)
                    return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
                if (i[1]) {
                    if (e = e instanceof rt ? e[0] : e, rt.merge(this, rt.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : Q, !0)), pt.test(i[1]) && rt.isPlainObject(e))
                        for (i in e)
    ...
    rt.fn.extend({
        ...
        closest: function(t, e) {
            for (var n, i = 0, o = this.length, r = [], a = ft.test(t) || "string" != typeof t ? rt(t, e || this.context) : 0; i < o; i++)
            ...
            c = {
                ...
                remove: function() {
                    return rt.each(arguments, function(t, e) {
                        for (var n; (n = rt.inArray(e, a, n)) > -1;)
                            a.splice(n, 1), n <= l && l--
                    }), this
                },
                has: function(t) {
        ...
        when: function(t) {
            ...
            if (a > 1)
                for (e = new Array(a), n = new Array(a), i = new Array(a); o < a; o++)
                    r[o] && rt.isFunction(r[o].promise) ? r[o].promise().progress(u(o, n, e)).done(u(o, i, r)).fail(l.reject) : --s;
    ...
    rt.extend({
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (o = Dt.get(r), 1 === r.nodeType && !Tt.get(r, "hasDataAttrs"))) {
                    for (n = a.length; n--;)
                        a[n] && (i = a[n].name, 0 === i.indexOf("data-") && (i = rt.camelCase(i.slice(5)), l(r, i, o[i])));
            ...
            return "object" == typeof t ? this.each(function() {
                ...
                var n,
                    i;
                if (r && void 0 === e) {
                    if (n = Dt.get(r, t) || Dt.get(r, t.replace(Mt, "-$&").toLowerCase()), void 0 !== n)
                        return n;
                    if (i = rt.camelCase(t), n = Dt.get(r, i), void 0 !== n)
                        return n;
                    if (n = l(r, i, void 0), void 0 !== n)
                        return n
                } else
                    i = rt.camelCase(t), this.each(function() {
                        var n = Dt.get(this, i);
        ...
        queue: function(t, e, n) {
            var i;
            if (t)
                return e = (e || "fx") + "queue", i = Tt.get(t, e), n && (!i || rt.isArray(n) ? i = Tt.access(t, e, rt.makeArray(n)) : i.push(n)), i || []
        },
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; a--;)
                n = Tt.get(r[a], t + "queueHooks"), n && n.empty && (i++, n.empty.add(s));
            return s(), o.promise(e)
        }
    });
    var It = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        Pt = new RegExp("^(?:([+-])=|)(" + It + ")([a-z%]*)$", "i"),
    ...
    rt.event = {
        ...
        add: function(t, e, n, i, o) {
            var r,
                ...
                m = Tt.get(t);
            if (m)
                for (n.handler && (r = n, n = r.handler, o = r.selector), n.guid || (n.guid = rt.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(e) {
                    return "undefined" != typeof rt && rt.event.triggered !== e.type ? rt.event.dispatch.apply(t, arguments) : void 0
                }), e = (e || "").match(wt) || [""], u = e.length; u--;)
                    s = Vt.exec(e[u]) || [], f = g = s[1], p = (s[2] || "").split(".").sort(), f && (d = rt.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = rt.event.special[f] || {}, c = rt.extend({
                        type: f,
                        origType: g,
                        data: i,
                        handler: n,
        ...
        remove: function(t, e, n, i, o) {
            var r,
                ...
                p,
                g,
                m = Tt.hasData(t) && Tt.get(t);
            if (m && (l = m.events)) {
                for (e = (e || "").match(wt) || [""], u = e.length; u--;)
                    if (s = Vt.exec(e[u]) || [], f = g = s[1], p = (s[2] || "").split(".").sort(), f) {
                        for (d = rt.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, h = l[f] || [], s = s[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = h.length; r--;)
        ...
        dispatch: function(t) {
            ...
            if (s[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                for (a = rt.event.handlers.call(this, t, l), e = 0; (o = a[e++]) && !t.isPropagationStopped();)
                    for (t.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped();)
                        t.rnamespace && !t.rnamespace.test(r.namespace) || (t.handleObj = r, t.data = r.data, i = ((rt.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, s), void 0 !== i && (t.result = i) === !1 && (t.preventDefault(), t.stopPropagation()));
            ...
            if (s && l.nodeType && ("click" !== t.type || isNaN(t.button) || t.button < 1))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                        for (i = [], n = 0; n < s; n++)
                            r = e[n], o = r.selector + " ", void 0 === i[o] && (i[o] = r.needsContext ? rt(o, this).index(l) > -1 : rt.find(o, this, null, [l]).length), i[o] && i.push(r);
                        i.length && a.push({
                            elem: l,
                            handlers: i
                        })
        ...
        fix: function(t) {
            ...
            var e,
                ...
                r = t,
                a = this.fixHooks[o];
            for (a || (this.fixHooks[o] = a = Wt.test(o) ? this.mouseHooks : Bt.test(o) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, t = new rt.Event(r), e = i.length; e--;)
                n = i[e], t[n] = r[n];
    ...
    rt.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (!(it.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || rt.isXMLDoc(t)))
                for (a = c(s), r = c(t), i = 0, o = r.length; i < o; i++)
                    w(r[i], a[i]);
            if (e)
                if (n)
                    for (r = r || c(t), a = a || c(s), i = 0, o = r.length; i < o; i++)
                        x(r[i], a[i]);
                else
                    x(t, s);
            ...
            for (var e, n, i, o = rt.event.special, r = 0; void 0 !== (n = t[r]); r++)
                if (St(n)) {
                    if (e = n[Tt.expando]) {
                        if (e.events)
                            for (i in e.events)
                                o[i] ? rt.event.remove(n, i) : rt.removeEvent(n, i, e.handle);
                        n[Tt.expando] = void 0
                    }
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (rt.cleanData(c(t, !1)), t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return Ct(this, function(t) {
                ...
                if (void 0 === t && 1 === e.nodeType)
                    return e.innerHTML;
                if ("string" == typeof t && !$t.test(t) && !Lt[(Ot.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = rt.htmlPrefilter(t);
                    try {
                        for (; n < i; n++)
                            e = this[n] || {}, 1 === e.nodeType && (rt.cleanData(c(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        rt.fn[t] = function(t) {
            for (var n, i = [], o = rt(t), r = o.length - 1, a = 0; a <= r; a++)
                n = a === r ? this : this.clone(!0), rt(o[a])[e](n), J.apply(i, n.get());
    ...
    rt.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o,
                    ...
                    s = rt.camelCase(e),
                    l = t.style;
                return e = rt.cssProps[s] || (rt.cssProps[s] = M(s) || s), a = rt.cssHooks[e] || rt.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (o = a.get(t, !1, i)) ? o : l[e] : (r = typeof n, "string" === r && (o = Pt.exec(n)) && o[1] && (n = u(t, e, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (rt.cssNumber[s] ? "" : "px")), it.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), a && "set" in a && void 0 === (n = a.set(t, n, i)) || (l[e] = n)), void 0)
            }
        },
        css: function(t, e, n, i) {
            var o,
                ...
                a,
                s = rt.camelCase(e);
            return e = rt.cssProps[s] || (rt.cssProps[s] = M(s) || s), a = rt.cssHooks[e] || rt.cssHooks[s], a && "get" in a && (o = a.get(t, !0, n)), void 0 === o && (o = D(t, e, i)), "normal" === o && e in ee && (o = ee[e]), "" === n || n ? (r = parseFloat(o), n === !0 || isFinite(r) ? r || 0 : o) : o
        }
    }), rt.each(["height", "width"], function(t, e) {
        rt.cssHooks[e] = {
            get: function(t, n, i) {
                if (n)
                    return Zt.test(rt.css(t, "display")) && 0 === t.offsetWidth ? Gt(t, te, function() {
                        return E(t, e, i)
                    }) : E(t, e, i)
            },
            set: function(t, n, i) {
                var o,
                    r = i && Kt(t),
                    a = i && P(t, e, i, "border-box" === rt.css(t, "boxSizing", !1, r), r);
        ...
        css: function(t, e) {
            return Ct(this, function(t, e, n) {
                var i,
                    ...
                    a = 0;
                if (rt.isArray(e)) {
                    for (i = Kt(t), o = e.length; a < o; a++)
                        r[e[a]] = rt.css(t, e[a], !1, i);
                    return r
                }
    ...
    rt.Animation = rt.extend(W, {
        ...
        tweener: function(t, e) {
            ...
            for (var n, i = 0, o = t.length; i < o; i++)
                n = t[i], W.tweeners[n] = W.tweeners[n] || [], W.tweeners[n].unshift(e)
        },
        prefilters: [_],
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"), this.each(function() {
                var e,
                    ...
                    r = rt.timers,
                    a = i ? i.length : 0;
                for (n.finish = !0, rt.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = r.length; e--;)
    ...
    rt.fn.extend({
        ...
        attr: function(t, e, n) {
            var i,
                ...
                r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r)
                return "undefined" == typeof t.getAttribute ? rt.prop(t, e, n) : (1 === r && rt.isXMLDoc(t) || (e = e.toLowerCase(), o = rt.attrHooks[e] || (rt.expr.match.bool.test(e) ? le : void 0)), void 0 !== n ? null === n ? void rt.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : (i = rt.find.attr(t, e), null == i ? void 0 : i))
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        removeAttr: function(t, e) {
            ...
            if (r && 1 === t.nodeType)
                for (; n = r[o++];)
                    i = rt.propFix[n] || n, rt.expr.match.bool.test(n) && (t[i] = !1), t.removeAttribute(n)
        }
    }), le = {
        set: function(t, e, n) {
    ...
    rt.fn.extend({
        ...
        prop: function(t, e, n) {
            var i,
                ...
                r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r)
                return 1 === r && rt.isXMLDoc(t) || (e = rt.propFix[e] || e, o = rt.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e]
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
        ...
        addClass: function(t) {
            ...
            if ("string" == typeof t && t)
                for (e = t.match(wt) || []; n = this[l++];)
                    if (o = V(n), i = 1 === n.nodeType && (" " + o + " ").replace(he, " ")) {
                        for (a = 0; r = e[a++];)
                            i.indexOf(" " + r + " ") < 0 && (i += r + " ");
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : rt.isFunction(t) ? this.each(function(n) {
                ...
                var e,
                    ...
                    r;
                if ("string" === n)
                    for (i = 0, o = rt(this), r = t.match(wt) || []; e = r[i++];)
                        o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                    void 0 !== t && "boolean" !== n || (e = V(this), e && Tt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || t === !1 ? "" : Tt.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e,
                ...
                i = 0;
            for (e = " " + t + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + V(n) + " ").replace(he, " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    });
    ...
    rt.fn.extend({
        val: function(t) {
                ...
                o = this[0];
            {
                ...
                if (o)
                    return e = rt.valHooks[o.type] || rt.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(fe, "") : null == n ? "" : n)
            }
        }
    }), rt.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var n, i, o = t.options, r = rt.makeArray(e), a = o.length; a--;)
                        i = o[a], (i.selected = rt.inArray(rt.valHooks.option.get(i), r) > -1) && (n = !0);
        ...
        trigger: function(e, n, i, o) {
            ...
            if (a = s = i = i || Q, 3 !== i.nodeType && 8 !== i.nodeType && !ge.test(f + rt.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), u = f.indexOf(":") < 0 && "on" + f, e = e[rt.expando] ? e : new rt.Event(f, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : rt.makeArray(n, [e]), d = rt.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!o && !d.noBubble && !rt.isWindow(i)) {
                    for (l = d.delegateType || f, ge.test(l + f) || (a = a.parentNode); a; a = a.parentNode)
                        h.push(a), s = a;
                    s === (i.ownerDocument || Q) && h.push(s.defaultView || s.parentWindow || t)
                }
                for (r = 0; (a = h[r++]) && !e.isPropagationStopped();)
                    e.type = r > 1 ? l : d.bindType || f, c = (Tt.get(a, "events") || {})[e.type] && Tt.get(a, "handle"), c && c.apply(a, n), c = u && a[u], c && c.apply && St(a) && (e.result = c.apply(a, n), e.result === !1 && e.preventDefault());
    ...
    var be = /#.*$/,
        ...
        De = {},
        Ae = "*/".concat("*"),
        Me = Q.createElement("a");
    Me.href = me.href, rt.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajaxSetup: function(t, e) {
            return e ? j(j(t, rt.ajaxSettings), e) : j(rt.ajaxSettings, t)
        },
        ajaxPrefilter: H(Te),
        ajaxTransport: H(De),
        ajax: function(e, n) {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = rt.param(h.data, h.traditional)), $(Te, h, n, k), 2 === x)
                return k;
            c = rt.event && h.global, c && 0 === rt.active++ && rt.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Ce.test(h.type), r = h.url, h.hasContent || (h.data && (r = h.url += (ye.test(r) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = xe.test(r) ? r.replace(xe, "$1_=" + ve++) : r + (ye.test(r) ? "&" : "?") + "_=" + ve++)), h.ifModified && (rt.lastModified[r] && k.setRequestHeader("If-Modified-Since", rt.lastModified[r]), rt.etag[r] && k.setRequestHeader("If-None-Match", rt.etag[r])), (h.data && h.hasContent && h.contentType !== !1 || n.contentType) && k.setRequestHeader("Content-Type", h.contentType), k.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ae + "; q=0.01" : "") : h.accepts["*"]);
            for (d in h.headers)
            ...
            for (d in {
                ...
                k[d](h[d]);
            if (o = $(De, h, n, k)) {
                if (k.readyState = 1, c && p.trigger("ajaxSend", [k, h]), 2 === x)
                    return k;
    ...
    rt.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !rt(this).is(":disabled") && Ne.test(this.nodeName) && !Fe.test(t) && (this.checked || !Nt.test(t))
            }).map(function(t, e) {
                var n = rt(this).val();
        ...
        if (it.cors || Re && !e.crossDomain)
            return {
                send: function(o, r) {
                    ...
                    n = function(t) {
                        return function() {
                            n && (n = i = s.onload = s.onerror = s.onabort = s.onreadystatechange = null, "abort" === t ? s.abort() : "error" === t ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(Oe[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                binary: s.response
                            } : {
                                text: s.responseText
    ...
    rt.ajaxSetup({
        ...
        var o,
            r,
            a,
            s = e.jsonp !== !1 && (_e.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && _e.test(e.data) && "data");
        if (s || "jsonp" === e.dataTypes[0])
            return o = e.jsonpCallback = rt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(_e, "$1" + o) : e.jsonp !== !1 && (e.url += (ye.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function() {
    ...
    rt.fn.load = function(t, e, n) {
        ...
        offset: function(t) {
            ...
            var e,
                ...
                r = i && i.ownerDocument;
            if (r)
                return e = r.documentElement, rt.contains(e, i) ? (o = i.getBoundingClientRect(), n = Y(r), {
        ...
        rt.cssHooks[e] = A(it.pixelPosition, function(t, n) {
            if (n)
                return n = D(t, e), Qt.test(n) ? rt(t).position()[e] + "px" : n
        })
    }), rt.each({
        Height: "height",
        Width: "width"
...
+function(t) {
    ...
    return function t(e, n, i) {
                ...
                if (t) {
                    ...
                    if (n) {
                        var i = parseFloat(n[4]),
                            o = y(parseInt(n[1]), 0, 360),
                            r = y(parseFloat(n[2]), 0, 100),
                            a = y(parseFloat(n[3]), 0, 100),
                            s = y(isNaN(i) ? 1 : i, 0, 1);
                        return [o, r, a, s]
                    }
                }
            ...
            r.prototype = {
                ...
                clone: function() {
                    var t,
                        ...
                        o = n.values;
                    for (var a in i)
                        i.hasOwnProperty(a) && (t = i[a], e = {}.toString.call(t), "[object Array]" === e ? o[a] = t.slice(0) : "[object Number]" === e && (o[a] = t));
                    return n
                }
            }, r.prototype.spaces = {
                rgb: ["red", "green", "blue"],
        ...
        4: [function(t, e, n) {
            ...
            function h(t) {
                ...
                for (var u = 0; u < 3; u++)
                    i = a + 1 / 3 * -(u - 1), i < 0 && i++, i > 1 && i--, r = 6 * i < 1 ? e + 6 * (n - e) * i : 2 * i < 1 ? n : 3 * i < 2 ? e + (n - e) * (2 / 3 - i) * 6 : e, o[u] = 255 * r;
                return o
            }
            function f(t) {
                var e,
                ...
                t.defaults.bar = {
                    ...
                    calculateBarBase: function(t, e) {
                        ...
                        if (o.options.stacked) {
                            for (var a = n.chart, s = a.data.datasets, l = Number(s[t].data[e]), u = 0; u < t; u++) {
                                var c = s[u],
                                    d = a.getDatasetMeta(u);
                    ...
                    updateElement: function(t, n, i) {
                        ...
                        t._model = {
                            ...
                            var l = [[n.base, r], [n.base, o], [a, o], [a, r]],
                                u = ["bottom", "left", "top", "right"],
                                c = u.indexOf(n.borderSkipped, 0);
                            c === -1 && (c = 0), e.moveTo.apply(e, t(0));
                            for (var d = 1; d < 4; d++)
                    ...
                    legend: {
                        ...
                        onClick: function(t, e) {
                            ...
                            for (n = 0, i = (a.data.datasets || []).length; n < i; ++n)
                                o = a.getDatasetMeta(n), o.data[r] && (o.data[r].hidden = !o.data[r].hidden);
                            a.update()
                        }
                    },
                    cutoutPercentage: 50,
                ...
                t.defaults.line = {
                    ...
                    draw: function(t) {
                        ...
                        for (n = 0, i = a.length; n < i; ++n)
                            a[n].transition(s);
                        for (e(o.getDataset(), o.chart.options) && r.dataset.transition(s).draw(), n = 0, i = a.length; n < i; ++n)
                            a[n].draw()
                    },
                    setHoverStyle: function(t) {
            ...
            e.exports = function(t) {
                ...
                e.drawPoint = function(t, e, n, i, o) {
                    var r,
                        ...
                        u,
                        c;
                    if ("object" == typeof e && (r = e.toString(), "[object HTMLImageElement]" === r || "[object HTMLCanvasElement]" === r))
                        return void t.drawImage(e, i - e.width / 2, o - e.height / 2);
                    if (!(isNaN(n) || n <= 0)) {
                        switch (e) {
                        default:
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function(e, n, i) {
                    ...
                    buildScales: function() {
                        ...
                        n.scales && (o = o.concat((n.scales.xAxes || []).map(function(t) {
                            ...
                            var o = n.options,
                                r = a.getValueOrDefault(o.type, n.dtype),
                    ...
                    render: function(e, n) {
                        ...
                        if (o && ("undefined" != typeof e && 0 !== e || "undefined" == typeof e && 0 !== o.duration)) {
                            ...
                            i.draw(), o && o.onComplete && o.onComplete.call && o.onComplete.call(i);
                        return i
                    },
                    draw: function(e) {
                        var n = this,
                    ...
                    destroy: function() {
                        var e,
                            ...
                            r = this,
                            s = r.chart.canvas;
                        for (r.stop(), n = 0, o = r.data.datasets.length; n < o; ++n)
                    ...
                    updateHoverStyle: function(t, e, n) {
                        ...
                        for (o = 0, r = t.length; o < r; ++o)
                            i = t[o], i && this.getDatasetMeta(i._datasetIndex).controller[a](i)
                    },
                ...
                t.DatasetController = function(t, e) {
                    ...
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex],
                            ...
                            a = i.getHoverColor,
                            s = t._model;
                        s.backgroundColor = o.hoverBackgroundColor ? o.hoverBackgroundColor : r(e.hoverBackgroundColor, n, a(s.backgroundColor)), s.borderColor = o.hoverBorderColor ? o.hoverBorderColor : r(e.hoverBorderColor, n, a(s.borderColor)),
                ...
                t.elements = {}, t.Element = function(t) {
                    ...
                    transition: function(t) {
                        ...
                        return n._view || (n._view = e.clone(n._model)), 1 === t ? (n._view = n._model, n._start = null, n) : (n._start || n.pivot(), e.each(n._model, function(i, o) {
                            if ("_" === o[0])
                                ;
                            else if (n._view.hasOwnProperty(o))
                                if (i === n._view[o])
                                    ;
                                ...
                                "number" != typeof i || isNaN(n._view[o]) ? n._view[o] = i : n._view[o] = i * t
                        }, n), n)
                    },
            ...
            e.exports = function(t) {
                ...
                r.each = function(t, e, n, i) {
                    ...
                    var e,
                        ...
                        s = a.length;
                    for (e = 0; e < s; ++e)
                        i = a[e], i.model.skip || (n = e > 0 ? a[e - 1] : null, o = e < s - 1 ? a[e + 1] : null, o && !o.model.skip && (i.deltaK = (o.model.y - i.model.y) / (o.model.x - i.model.x)), !n || n.model.skip ? i.mK = i.deltaK : !o || o.model.skip ? i.mK = n.deltaK : this.sign(n.deltaK) !== this.sign(i.deltaK) ? i.mK = 0 : i.mK = (n.deltaK + i.deltaK) / 2);
                    var l,
                        u,
                        c,
                        d;
                    for (e = 0; e < s - 1; ++e)
                        i = a[e], o = a[e + 1], i.model.skip || o.model.skip || (r.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = o.mK = 0 : (l = i.mK / i.deltaK, u = o.mK / i.deltaK, d = Math.pow(l, 2) + Math.pow(u, 2), d <= 9 || (c = 3 / Math.sqrt(d), i.mK = l * c * i.deltaK, o.mK = u * c * i.deltaK)));
                    var h;
                    for (e = 0; e < s; ++e)
                        i = a[e], i.model.skip || (n = e > 0 ? a[e - 1] : null, o = e < s - 1 ? a[e + 1] : null, n && !n.model.skip && (h = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - h, i.model.controlPointPreviousY = i.model.y - h * i.mK), o && !o.model.skip && (h = (o.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + h, i.model.controlPointNextY = i.model.y + h * i.mK))
            ...
            e.exports = function(t) {
                ...
                t.Interaction = {
                    modes: {
                        ...
                        x: function(t, n, i) {
                            var o = r.getRelativePosition(n, t.chart),
                                a = [],
                                s = !1;
                            return e(t, function(t) {
                ...
                t.layoutService = {
                    ...
                    update: function(t, n, i) {
                        function o(t) {
                            var e,
                                n = t.isHorizontal();
                            n ? (e = t.update(t.options.fullWidth ? b : T, S), D -= e.height) : (e = t.update(C, k), T -= e.width), A.push({
                                horizontal: n,
                                minSize: e,
                                box: t
                            })
                        ...
                        function r(t) {
                            var n = e.findNextWhere(A, function(e) {
                                return e.box === t
                            });
                            if (n)
                                if (t.isHorizontal()) {
                        ...
                        function s(t) {
                            t.isHorizontal() ? (t.left = t.options.fullWidth ? c : M, t.right = t.options.fullWidth ? n - d : M + T, t.top = R, t.bottom = R + t.height, R = t.bottom) : (t.left = O, t.right = O + t.width, t.top = P, t.bottom = P + D, O = t.right)
                        }
                        if (t) {
                            ...
                            var b = n - c - d,
                                ...
                                w = b / 2,
                                k = x / 2,
                                C = (n - w) / (p.length + g.length),
                                S = (i - k) / (m.length + v.length),
                                T = b,
                                D = x,
                                A = [];
                            ...
                            e.each(p.concat(g), r), e.each(p, function(t) {
                                ...
                                E += t.height
                            }), e.each(p.concat(g), a), M = c, I = d, P = h, E = f, e.each(p, function(t) {
                                M += t.width
                            }), e.each(g, function(t) {
                                I += t.width
                            }), e.each(m, function(t) {
                            ...
                            var F = i - P - E,
                                N = n - M - I;
                            N === T && F === D || (e.each(p, function(t) {
                                t.height = F
                            }), e.each(g, function(t) {
                                t.height = F
                            }), e.each(m, function(t) {
                                t.options.fullWidth || (t.width = N)
                            }), e.each(v, function(t) {
                                t.options.fullWidth || (t.width = N)
                            }), D = F, T = N);
                            var O = c,
                                R = h;
                            e.each(p.concat(m), s), O += T, R += D, e.each(g, s), e.each(v, s), t.chartArea = {
                                left: M,
                                top: P,
                                right: M + T,
                                bottom: P + D
                        ...
                        if (m ? (g.width = i.maxWidth, g.height = a ? 10 : 0) : (g.width = a ? 10 : 0, g.height = i.maxHeight), a)
                            if (s.font = f, m) {
                                ...
                                n.each(i.legendItems, function(t, n) {
                                    var i = e(r, c),
                                        o = i + c / 2 + s.measureText(t.text).width;
                        ...
                        if (o.display) {
                            ...
                            n.each(i.legendItems, function(t, e) {
                                var n = d.measureText(t.text).width,
                                    ...
                                    a = c.x,
                                    s = c.y;
                                k ? a + o >= l && (s = c.y += C, c.line++, a = c.x = i.left + (l - u[c.line]) / 2) : s + C > i.bottom && (a = c.x = a + i.columnWidths[c.line] + r.padding, s = c.y = i.top, c.line++), x(a, s, t), b[e].left = a, b[e].top = s, w(a, s, t, n), k ? c.x += o + r.padding : c.y += C
                            })
                        }
                    },
                    handleEvent: function(t) {
                        ...
                        var a = n.getRelativePosition(t, e.chart.chart),
                            s = a.x,
                            l = a.y;
                        if (s >= e.left && s <= e.right && l >= e.top && l <= e.bottom)
                            for (var u = e.legendHitBoxes, c = 0; c < u.length; ++c) {
                                var d = u[c];
                ...
                t.plugins = {
                    ...
                    notify: function(t, e) {
                        var n,
                            ...
                            r = o.length;
                        for (n = 0; n < r; ++n)
                            if (i = o[n], "function" == typeof i[t] && i[t].apply(i, e || []) === !1)
                                return !1;
                        return !0
                    }
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function() {
                        var n = this,
                            ...
                            u = e.fontString(a, s, l);
                        i.font = u;
                        var c,
                            d = i.measureText(n.ticks[0]).width,
                    ...
                    fit: function() {
                        var n = this,
                            ...
                            f = e.getValueOrDefault(a.fontFamily, r.defaultFontFamily),
                            p = e.fontString(d, h, f),
                        ...
                        if (c ? i.width = n.isFullWidth() ? n.maxWidth - n.margins.left - n.margins.right : n.maxWidth : i.width = u && l.drawTicks ? m : 0, c ? i.height = u && l.drawTicks ? m : 0 : i.height = n.maxHeight, s.display && u && (c ? i.height += 1.5 * g : i.width += 1.5 * g), a.display && u) {
                            ...
                            if (c) {
                                ...
                                var w = n.ctx.measureText(n.ticks[0]).width,
                                    ...
                                    C = Math.cos(e.toRadians(n.labelRotation)),
                                    S = Math.sin(e.toRadians(n.labelRotation));
                                n.paddingLeft = 0 !== n.labelRotation ? C * w + 3 : w / 2 + 3, n.paddingRight = 0 !== n.labelRotation ? S * (d / 2) + 3 : k / 2 + 3
                            } else {
                                var T = n.maxWidth - i.width,
                                    D = a.mirror;
                                D ? v = 0 : v += n.options.ticks.padding, v < T ? i.width += v : i.width = n.maxWidth, n.paddingTop = d / 2, n.paddingBottom = d / 2
                            }
                        }
                        n.margins && (n.paddingLeft = Math.max(n.paddingLeft - n.margins.left, 0), n.paddingTop = Math.max(n.paddingTop - n.margins.top, 0),
                        n.paddingRight = Math.max(n.paddingRight - n.margins.right, 0), n.paddingBottom = Math.max(n.paddingBottom - n.margins.bottom, 0)), n.width = i.width, n.height = i.height
                    },
                    afterFit: function() {
                    ...
                    draw: function(n) {
                        ...
                        if (o.display) {
                            ...
                            var g = e.getValueOrDefault(u.fontColor, l.defaultFontColor),
                                ...
                                y = e.getValueOrDefault(u.fontFamily, l.defaultFontFamily),
                                ...
                                C = e.getValueOrDefault(d.fontColor, l.defaultFontColor),
                                S = e.getValueOrDefault(d.fontSize, l.defaultFontSize),
                                T = e.getValueOrDefault(d.fontStyle, l.defaultFontStyle),
                                D = e.getValueOrDefault(d.fontFamily, l.defaultFontFamily),
                                A = e.fontString(S, T, D),
                                M = e.toRadians(i.labelRotation),
                                I = Math.cos(M),
                                P = i.longestLabelWidth * I;
                            s.fillStyle = g;
                            var E = [];
                            if (p) {
                                if (r = !1, h && (P /= 2), (P + u.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (r = 1 + Math.floor((P + u.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), a && i.ticks.length > a)
                                    for (; !r || i.ticks.length / (r || 1) > a;)
                                        r || (r = 1), r += 1;
                                f || (r = !1)
                            }
                            var F = "right" === o.position ? i.left : i.right - x,
                                N = "right" === o.position ? i.left + x : i.right,
                                O = "bottom" === o.position ? i.top : i.bottom - x,
                                R = "bottom" === o.position ? i.top + x : i.bottom;
                            if (e.each(i.ticks, function(t, a) {
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ((!l || s) && void 0 !== t && null !== t) {
                                        ...
                                        var g,
                                            ...
                                            P = "middle";
                                        if (p) {
                                            h || (P = "top" === o.position ? "bottom" : "top"), I = h ? "right" : "center";
                                            var L = i.getPixelForTick(a) + e.aliasPixel(d);
                                            D = i.getPixelForTick(a, c.offsetGridLines) + u.labelOffset, A = h ? i.top + 12 : "top" === o.position ? i.bottom - x : i.top + x, g = v = b = S = L, m = O, y = R, C = n.top, T = n.bottom
                                        } else {
                                            "left" === o.position ? u.mirror ? (D = i.right + u.padding, I = "left") : (D = i.right - u.padding, I = "right") : u.mirror ? (D = i.left - u.padding, I = "right") : (D = i.left + u.padding, I = "left");
                                            var _ = i.getPixelForTick(a);
                                            _ += e.aliasPixel(d), A = i.getPixelForTick(a, c.offsetGridLines), g = F, v = N, b = n.left, S = n.right, m = y = C = T = _
                                        }
                                        E.push({
                                            tx1: g,
                                            ty1: m,
                                ...
                                if (c.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), c.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), c.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
                                    ...
                                    var n = t.label;
                                    if (e.isArray(n))
                                        for (var i = 0, o = -(n.length - 1) * m * .75; i < n.length; ++i)
                                            s.fillText("" + n[i], 0, o), o += 1.5 * m;
                                    else
                                        s.fillText(n, 0, 0);
                                    s.restore()
                                }
                                ...
                                var L,
                                    ...
                                    B = 0;
                                if (p)
                                    L = i.left + (i.right - i.left) / 2, _ = "bottom" === o.position ? i.bottom - S / 2 : i.top + S / 2;
                                else {
                                    var W = "left" === o.position;
                                    L = W ? i.left + S / 2 : i.right - S / 2, _ = i.top + (i.bottom - i.top) / 2, B = W ? -.5 * Math.PI : .5 * Math.PI
                                }
                                s.save(), s.translate(L, _), s.rotate(B), s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = C, s.font = A, s.fillText(d.labelString, 0, 0), s.restore()
                            }
                            if (c.drawBorder) {
                                ...
                                var V = i.left,
                                    ...
                                    $ = i.top,
                                    j = i.bottom,
                                    z = e.aliasPixel(s.lineWidth);
                                p ? ($ = j = "top" === o.position ? i.bottom : i.top, $ += z, j += z) : (V = H = "left" === o.position ? i.right : i.left, V += z, H += z), s.beginPath(), s.moveTo(V, $), s.lineTo(H, j), s.stroke()
                            }
                        }
                    }
                })
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function() {
                        ...
                        var d,
                            ...
                            p;
                        if (u.length && o.fill) {
                            for (l.beginPath(), d = 0; d < u.length; ++d)
                                h = u[d], f = e.previousItem(u, d), p = h._view, 0 === d ? (s ? l.moveTo(a.x, a.y) : l.moveTo(p.x, a), p.skip || (c = d, l.lineTo(p.x, p.y))) : (f = c === -1 ? f : u[c], p.skip ? r || c !== d - 1 || (s ? l.lineTo(a.x, a.y) : l.lineTo(f._view.x, a)) : (c !== d - 1 ? r && c !== -1 ? t(f, h) : s ? l.lineTo(p.x, p.y) : (l.lineTo(p.x, a), l.lineTo(p.x, p.y)) : t(f, h), c = d));
                            s || c === -1 || l.lineTo(u[c]._view.x, a), l.fillStyle = o.backgroundColor || n.defaultColor, l.closePath(), l.fill()
                        }
                        var g = n.elements.line;
                        for (l.lineCap = o.borderCapStyle || g.borderCapStyle, l.setLineDash && l.setLineDash(o.borderDash || g.borderDash), l.lineDashOffset = o.borderDashOffset || g.borderDashOffset, l.lineJoin = o.borderJoinStyle || g.borderJoinStyle, l.lineWidth = o.borderWidth || g.borderWidth, l.strokeStyle = o.borderColor || n.defaultColor, l.beginPath(), c = -1, d = 0; d < u.length; ++d)
                            h = u[d], f = e.previousItem(u, d), p = h._view, 0 === d ? p.skip || (l.moveTo(p.x, p.y), c = d) : (f = c === -1 ? f : u[c], p.skip || (c !== d - 1 && !r || c === -1 ? l.moveTo(p.x, p.y) : t(f, h), c = d));
                        l.stroke(), l.restore()
                    }
                })
            }
                ...
                i.elements.rectangle = {
                    ...
                    draw: function() {
                        ...
                        var e = this._chart.ctx,
                            ...
                            s = n.borderWidth / 2;
                        n.borderWidth && (o += s, r -= s, a += s), e.beginPath(), e.fillStyle = n.backgroundColor, e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth;
                        var l = [[o, n.base], [o, a], [r, a], [r, n.base]],
                            u = ["bottom", "left", "top", "right"],
                            c = u.indexOf(n.borderSkipped, 0);
                        c === -1 && (c = 0);
                        var d = t(0);
                ...
                var e = t.helpers,
                    ...
                    i = t.Scale.extend({
                        ...
                        getPixelForValue: function(t, e, n, i) {
                            ...
                            var d = o.height - (o.paddingTop + o.paddingBottom),
                                h = d / r,
                        ...
                        getValueForPixel: function(t) {
                            var e,
                                ...
                                a = r / i;
                            return t -= o ? n.left : n.top, n.options.gridLines.offsetGridLines && (t -= a / 2), t -= o ? n.paddingLeft : n.paddingTop, e = t <= 0 ? 0 : Math.round(t / a)
                        },
                        getBasePixel: function() {
                            return this.bottom
                        }
                            ...
                            if (n.min = null, n.max = null, i.stacked) {
                                ...
                                e.each(a, function(r, a) {
                                    ...
                                    o.isDatasetVisible(a) && t(s) && e.each(r.data, function(t, e) {
                                        ...
                                        isNaN(o) || s.data[e].hidden || (u[e] = u[e] || 0, c[e] = c[e] || 0, i.relativePoints ? u[e] = 100 : o < 0 ? c[e] += o : u[e] += o)
                                    })
                                }), e.each(l, function(t) {
                    ...
                    o = t.LinearScaleBase.extend({
                        ...
                        setDimensions: function() {
                            ...
                            var r = e.min([t.height, t.width]),
                                a = e.getValueOrDefault(o.fontSize, n.defaultFontSize);
                        ...
                        fit: function() {
                            ...
                            for (this.ctx.font = y, i = 0; i < this.getValueCount(); i++) {
                                ...
                                var k = this.getIndexAngle(i) + Math.PI / 2,
                                    C = 360 * k / (2 * Math.PI) % 360;
                                0 === C || 180 === C ? (r = o / 2, t.x + r > x && (x = t.x + r, a = i), t.x - r < w && (w = t.x - r, l = i)) : C < 180 ? t.x + o > x && (x = t.x + o, a = i) : t.x - o < w && (w = t.x - o, l = i)
                            }
                        ...
                        draw: function() {
                            ...
                            if (i.display) {
                                var u = t.ctx,
                                    c = l(r.fontSize, n.defaultFontSize),
                                    d = l(r.fontStyle, n.defaultFontStyle),
                                ...
                                if (e.each(t.ticks, function(a, s) {
                                    if (s > 0 || i.reverse) {
                                        var d = t.getDistanceFromCenterForValue(t.ticksAsNumbers[s]),
                                            h = t.yCenter - d;
                                        if (o.display && 0 !== s)
                                            if (u.strokeStyle = e.getValueAtIndexOrDefault(o.color, s - 1), u.lineWidth = e.getValueAtIndexOrDefault(o.lineWidth, s - 1), i.lineArc)
                                                u.beginPath(), u.arc(t.xCenter, t.yCenter, d, 0, 2 * Math.PI), u.closePath(), u.stroke();
                                            else {
                                                u.beginPath();
                                    ...
                                    for (var p = t.getDistanceFromCenterForValue(i.reverse ? t.min : t.max), g = l(s.fontSize, n.defaultFontSize), m = l(s.fontStyle, n.defaultFontStyle), v = l(s.fontFamily, n.defaultFontFamily), y = e.fontString(g, m, v), b = t.getValueCount() - 1; b >= 0; b--) {
                                        ...
                                        var w = t.getPointPosition(b, p + 5),
                                            k = l(s.fontColor, n.defaultFontColor);
                                        u.font = y, u.fillStyle = k;
                                        var C = t.pointLabels,
                                            S = this.getIndexAngle(b) + Math.PI / 2,
                                            T = 360 * S / (2 * Math.PI) % 360;
                                        0 === T || 180 === T ? u.textAlign = "center" : T < 180 ? u.textAlign = "left" : u.textAlign = "right", 90 === T || 270 === T ? u.textBaseline = "middle" : T > 270 || T < 90 ? u.textBaseline = "bottom" : u.textBaseline = "top", u.fillText(C[b] ? C[b] : "", w.x, w.y)
                                    }
                                }
                            }
                        }
                        ...
                        buildTicks: function() {
                            ...
                            if (i.options.time.min ? b = i.getMomentStartOf(i.firstTick) : (i.firstTick = i.getMomentStartOf(i.firstTick), b = i.firstTick), !i.options.time.max) {
                                var x = i.getMomentStartOf(i.lastTick),
                                    w = x.diff(i.lastTick, i.tickUnit, !0);
                            ...
                            for (var k = 1; k <= i.scaleSizeInUnits; ++k) {
                                ...
                                if (i.options.time.max && C.diff(i.lastTick, i.tickUnit, !0) >= 0)
                                    break;
                                k % i.unitScale === 0 && i.ticks.push(C)
                            }
    ...
    for (x = {
        ...
        for (e = arguments[0], i = 2 <= arguments.length ? Q.call(arguments, 1) : [], r = 0, a = i.length; r < a; r++)
            if (n = i[r])
                for (t in n)
                    K.call(n, t) && (o = n[t], null != e[t] && "object" == typeof e[t] && null != o && "object" == typeof o ? w(e[t], o) : e[t] = o);
        return e
    }, m = function(t) {
        var e,
            n,
        ...
        if (null == t && (t = "options"), null == e && (e = !0), o = document.querySelector("[data-pace-" + t + "]")) {
            if (n = o.getAttribute("data-pace-" + t), !e)
                return n;
            try {
                return JSON.parse(n)
            } catch (t) {
        ...
        return t.prototype.on = function(t, e, n, i) {
            ...
            if (n = arguments[0], t = 2 <= arguments.length ? Q.call(arguments, 1) : [], null != (a = this.bindings) ? a[n] : void 0) {
                for (o = 0, l = []; o < this.bindings[n].length;)
                    s = this.bindings[n][o], i = s.handler, e = s.ctx, r = s.once, i.apply(null != e ? e : this, t), r ? l.push(this.bindings[n].splice(o, 1)) : l.push(o++);
                return l
            }
        }, t
    }(), u = window.Pace || {}, window.Pace = u, w(u, a.prototype), I = u.options = w({}, x, window.paceOptions, C()), U = ["ajax", "document", "eventLag", "elements"], $ = 0, z = U.length; $ < z; $++)
        L = U[$], I[L] === !0 && (I[L] = x[L]);
    l = function(t) {
        function e() {
        ...
        return t.prototype.getElement = function() {
            ...
            var t,
                ...
                r,
                a;
            if (null == document.querySelector(I.target))
                return !1;
            for (t = this.getElement(), i = "translate3d(" + this.progress + "%, 0, 0)", a = ["webkitTransform", "msTransform", "transform"], o = 0, r = a.length; o < r; o++)
                e = a[o], t.children[0].style[e] = i;
        ...
        return t.prototype.trigger = function(t, e) {
            ...
            if (null != this.bindings[t]) {
                for (r = this.bindings[t], a = [], i = 0, o = r.length; i < o; i++)
                    n = r[i], a.push(n.call(this, e));
                return a
            }
    ...
    }(), H = window.XMLHttpRequest, V = window.XDomainRequest, W = window.WebSocket, k = function(t, e) {
        var n,
            i,
            o;
        o = [];
        ...
        var e;
        if (null == t && (t = "GET"), "track" === D[0])
            return "force";
        if (!D.length && I.ajax) {
            if ("socket" === t && I.ajax.trackWebSockets)
                return !0;
            if (e = t.toUpperCase(), J.call(I.ajax.trackMethods, e) >= 0)
                return !0
        }
        return !1
    }, c = function(t) {
        ...
        var n,
            ...
            r,
            a;
        if (r = e.type, o = e.request, a = e.url, !O(a))
            return u.running || I.restartOnRequestAfter === !1 && "force" !== R(r) ? void 0 : (i = arguments, n = I.restartOnRequestAfter || 0, "boolean" == typeof n && (n = 0), setTimeout(function() {
                var e,
                    n,
                    a,
                    s,
        ...
        return t.prototype.watch = function(t) {
            var e,
                ...
                i,
                o;
            if (i = t.type, e = t.request, o = t.url, !O(o))
                return n = "socket" === i ? new f(e) : new p(e), this.elements.push(n)
        }, t
    }(), p = function() {
        function t(t) {
            var e,
            ...
            if (this.progress = 0, null != window.ProgressEvent)
                ...
                }, !1), a = ["load", "abort", "timeout", "error"], i = 0, o = a.length; i < o; i++)
        ...
        function t(t) {
            var e,
                ...
                o,
                r = this;
            for (this.progress = 0, o = ["error", "open"], n = 0, i = o.length; n < i; n++)
        ...
        function t(t) {
            var e,
                ...
                i,
                r;
            for (null == t && (t = {}), this.elements = [], null == t.selectors && (t.selectors = []), r = t.selectors, n = 0, i = r.length; n < i; n++)
        ...
        function t() {
            ...
            this.progress = 0, t = 0, o = [], i = 0, n = M(), e = setInterval(function() {
                var a;
                return a = M() - n - 50, n = M(), o.push(a), o.length > I.eventLag.sampleCount && o.shift(), t = m(o), ++i >= I.eventLag.minSamples && t < I.eventLag.lagThreshold ? (r.progress = 100, clearInterval(e)) : r.progress = 100 * (3 / (t + 3))
            }, 50)
        }
        return t
    }(), h = function() {
    ...
    }(), _ = null, N = null, v = null, B = null, g = null, y = null, u.running = !1, T = function() {
        if (I.restartOnPushState)
            return u.restart()
        ...
        var t,
            ...
            s,
            l;
        for (u.sources = _ = [], a = ["ajax", "elements", "document", "eventLag"], n = 0, o = a.length; n < o; n++)
            t = a[n], I[t] !== !1 && _.push(new d[t](I[t]));
        for (l = null != (s = I.extraSources) ? s : [], i = 0, r = l.length; i < r; i++)
            L = l[i], _.push(new L(I));
        return u.bar = v = new e, N = [], B = new h
    })(), u.stop = function() {
        ...
        var t;
        return u.running = !0, v.render(), t = M(), y = !1, g = F(function(e, n) {
            var i,
                o,
                r,
                a,
                ...
                w,
                k;
            for (d = 100 - v.progress, o = g = 0, r = !0, l = m = 0, x = _.length; m < x; l = ++m)
                for (L = _[l], p = null != N[l] ? N[l] : N[l] = [], s = null != (k = L.elements) ? k : [L], c = b = 0, w = s.length; b < w; c = ++b)
                    a = s[c], f = null != p[c] ? p[c] : p[c] = new h(a), r &= f.done, f.done || (o++, g += f.tick(e));
        ...
        return o.prototype.defaults = {
                        ...
                        for (a = [], n = 0, i = e.length; n < i; n++)
                            r = e[n], a.push(function() {
                                var t,
                                    ...
                                    n,
                                    i;
                                for (n = r.addedNodes || [], i = [], t = 0, e = n.length; t < e; t++)
            ...
            if (null == t && (t = this.element), 1 === t.nodeType) {
                for (t = t.parentNode || t, o = t.querySelectorAll("." + this.config.boxClass), r = [], n = 0, i = o.length; n < i; n++)
                    e = o[n], a.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0),
            ...
            for (n in e)
                o = e[n], t["" + n] = o, i.push(function() {
                    var e,
                        ...
                        a,
                        s;
                    for (a = this.vendors, s = [], e = 0, i = a.length; e < i; e++)
            ...
            var n,
                ...
                s,
                l;
            for (s = i(t), a = s.getPropertyCSSValue(e), r = this.vendors, n = 0, o = r.length; n < o; n++)
